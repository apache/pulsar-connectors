...
public class ProcessedFileThreadTest extends AbstractFileTest {
    ...
    public final void continuousRunTest() throws IOException {
        ...
        try {
            ...
            generatorThread = new TestFileGenerator(producedFiles, 5000, 100, 1,
    ...
    public final void renameFileTest() throws IOException {
        ...
        try {
            // Start producing files, with a .1 sec delay between
            generatorThread =
                    new TestFileGenerator(producedFiles, 500, 100, 1, directory.toString(),
