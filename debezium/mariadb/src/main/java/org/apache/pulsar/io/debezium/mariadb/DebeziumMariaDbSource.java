...
public class DebeziumMariaDbSource extends DebeziumSource {
    private static final String DEFAULT_CONNECTOR = "io.debezium.connector.mariadb.MariaDbConnector";
    private static final String DEFAULT_TASK = "io.debezium.connector.mariadb.MariaDbConnectorTask";
